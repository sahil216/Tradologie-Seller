...
static NSTimeInterval const kINSSearchBarAnimationStepDuration = 0.60;
...
{
    if ((self = [super initWithFrame:CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame), CGRectGetWidth(frame), 40)]))
	{
        // Initialization code
		self.opaque = NO;
		...
		self.searchField.font = [UIFont fontWithName:@"HelveticaNeue-Medium" size:16.0];
        [self.searchField setPlaceholder:@"Search Text here"];
		self.searchField.textColor = DEFAULT_COLOR;
		self.searchField.alpha = 0.0;
        [self.searchField setTintColor:DEFAULT_COLOR];
		...
		self.searchImageViewOn.image = [UIImage imageNamed:@"IconSearchBarBlue"];
        [self changeImageColor:self.searchImageViewOn withColor:DEFAULT_COLOR];
		...
		self.searchImageCircle.image = [UIImage imageNamed:@"IconSearchCircle"];
        [self changeImageColor:self.searchImageCircle withColor:DEFAULT_COLOR];
		...
		self.searchImageCrossLeft.image = [UIImage imageNamed:@"IconSearchCross"];
        [self changeImageColor:self.searchImageCrossLeft withColor:DEFAULT_COLOR];
		...
		self.searchImageCrossRight.image = [UIImage imageNamed:@"IconSearchClose"];
        [self changeImageColor:self.searchImageCrossRight withColor:DEFAULT_COLOR];
		...
		self.searchImageViewOff.image = [UIImage imageNamed:@"IconSearchWhite"];
        [self changeImageColor:self.searchImageViewOff withColor:[UIColor whiteColor]];
...
-(void)changeImageColor:(UIImageView *)imgview withColor:(UIColor *)color
{

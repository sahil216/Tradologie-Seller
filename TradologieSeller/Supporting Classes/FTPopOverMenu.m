...
#define FTDefaultMenuIconMargin             10.f
...
#define FTDefaultBackgroundColor            [UIColor colorWithRed:29.0f/255.0f green:65.0f/255.0f blue:106.0f/255.0f alpha:.30f]
#define FTDefaultTintColor                  [UIColor colorWithRed:80/255.0f green:80/255.0f blue:80/255.0f alpha:1.0f]
#define FTDefaultTextColor                  [UIColor colorWithRed:47/255.0f green:73/255.0f blue:90/255.0f alpha:1.0f]
#define FTDefaultMenuFont                   [UIFont systemFontOfSize:15.0f]
#define FTDefaultMenuWidth                  150.f
#define FTDefaultMenuIconSize               24.f
#define FTDefaultMenuRowHeight              50.f
#define FTDefaultMenuBorderWidth            1.0f
#define FTDefaultMenuArrowWidth             8.0f
#define FTDefaultMenuArrowHeight            10.0f
#define FTDefaultMenuArrowWidth_R           12.0f
#define FTDefaultMenuArrowHeight_R          12.0f
#define FTDefaultMenuArrowRoundRadius       4.0f
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.textFont =  [UIFont fontWithName:@"HelveticaNeue-Medium" size:16]; //FTDefaultMenuFont;
...
-(UITableView *)menuTableView
{
    if (!_menuTableView) {
        ...
        _menuTableView.separatorColor = [UIColor whiteColor];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [menuCell setBackgroundColor: [UIColor colorWithRed:29.0f/255.0f green:65.0f/255.0f blue:106.0f/255.0f alpha:1.0f]];
    return menuCell;
}

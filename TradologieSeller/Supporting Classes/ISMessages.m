...
- (void)constructAlertCardView {
    ...
    messageLabel.frame = CGRectMake((kDefaulInset*2.f) + _iconImageSize.width,self.view.frame.size.height/2-_messageLabelHeight/2 , self.view.frame.size.width - ((kDefaulInset*3.f) + _iconImageSize.width), _messageLabelHeight);
